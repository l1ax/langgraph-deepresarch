...
export const ResearcherNodeUi = observer((props: NodeProps) => {
    ...
    const statusStyles = {
        pending: {
            container: 'border-cyan-200 bg-cyan-50/30',
            header: 'bg-cyan-100/80 border-cyan-200',
            icon: 'bg-cyan-100 text-cyan-500',
            text: 'text-cyan-700',
        },
        running: {
            container: 'border-cyan-400 bg-cyan-50/50',
            header: 'bg-cyan-200/80 border-cyan-300',
    ...
    return (
        ...
        >
            ...
            <div 
                className="relative w-full bg-gradient-to-b from-transparent to-cyan-50/20"
